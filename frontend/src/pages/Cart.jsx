            ...
            <div className="flex flex-col w-[80%]">
              ...
              {cartItems.map((item) => (
                <div key={item._id} className="flex items-center mb-[1rem] pb-2 border-b border-gray-700">
                  ...
                  <div className="w-24">
                    <select
                      className="w-full p-1 rounded bg-[#1f1f1f] border border-gray-600 text-white focus:ring-2 focus:ring-pink-500 focus:outline-none"
                      value={item.qty}
                      onChange={(e) =>
              ...
              <div className="mt-8 w-[40rem]">
                <div className="p-4 rounded-lg border border-gray-700 text-white">
                  ...
                  <button
                    className="bg-pink-500 mt-4 py-2 px-4 rounded-full text-lg w-full hover:bg-pink-600 transition-colors duration-200"
